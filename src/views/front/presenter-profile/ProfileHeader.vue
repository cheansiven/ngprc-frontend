        ...
        >
          ...
          >
            <template #tabs-start>
              <b-nav-item
                role="presentation"
                :active="$props.activeTab == 'presentation'"
                class="font-weight-bold"
                @click="$emit('nav:update','presentation')"
              >
                <span class="d-none d-md-block">Presentations</span>
                <feather-icon
                  icon="RssIcon"
              ...
              <b-nav-item
                role="presentation"
                :active="$props.activeTab == 'forums'"
                class="font-weight-bold"
                @click="$emit('nav:update','forums')"
              >
